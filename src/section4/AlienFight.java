	...
	public class AlienFight {
		...
		public static void main(String[] args) {
			...
			ImageIcon dragon = new ImageIcon("src/section4/dragon.png");		
		...
		while(playerhealth>0 && dragonhealth>0) {
			...
			String attack=JOptionPane.showInputDialog(null, "do you want to attack with sword, kick, or torch, heal,scream");
