...
//7. Create an int variable that holds the background color. 
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("336641__duckers-duckerson__jumpscare-3 (1).wav"));
